...
| 角色 | Git 仓库 | 路径 | 内容 |
|---|---|---|---|
| 工作区父仓 | https://github.com/hm-harry/first | `.` | Harness（`.qoder/`）+ Spec（`openspec/`）+ submodule 指针 |
| Backend submodule | https://github.com/hm-harry/first_backend | `backend/` | Java 17 + Spring Boot 3.3.5，HTTP API（端口 8080） |
| Frontend submodule | https://github.com/hm-harry/first_frontend | `frontend/` | Next.js 16 (App Router) + React 19 + TypeScript，UI 与薄 BFF（端口 3000） |
...
```bash
git clone --recursive https://github.com/hm-harry/first.git
...
- 仓库：https://github.com/hm-harry/first_backend
...
- 仓库：https://github.com/hm-harry/first_frontend
